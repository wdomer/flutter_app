...
import 'package:flutter_app/local_database/all_surveys.dart';
import 'package:flutter_app/local_database/moor_database.dart';
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                text: TextSpan(
                                  text:AppLocalizations.of(context) .tr("Created on  "),
                                  style: TextStyle(
                      ...
                      InkWell(
                        onTap: () async {
                          _scaffoldKey.currentState.showSnackBar(
                              SnackBar(content: Text(AppLocalizations.of(context).tr("downloading ....."))));
                          ...
                          response.whenComplete(
                            () => _scaffoldKey.currentState.showSnackBar(
                              SnackBar(
                                content: Text(AppLocalizations.of(context).tr("done")),
