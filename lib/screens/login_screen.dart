                                    ...
                                    onPressed: () async {
                                      ...
                                      if (!_formKey.currentState.validate()) {
                                        ...
                                        _scaffoldKey.currentState.showSnackBar(
                                            SnackBar(
                                                content: Text(
                                                    AppLocalizations.of(context).tr("Email and Password is required")
                                                    )));
                                      }
                                      if (_formKey.currentState.validate() &&
                                          _rememberMe == true) {
                                        ...
                                        if (response.statusCode == 200 ||
                                          ...
                                          _scaffoldKey.currentState
                                              .showSnackBar(SnackBar(
                                                  content: Text(
                                                      AppLocalizations.of(context).tr("Please wait ...."))));
...
//
                                      ...
                                      if ((_formKey.currentState.validate())) {
                                        ...
                                        if (response.statusCode == 200 ||
                                          ...
                                          _scaffoldKey.currentState
                                              .showSnackBar(SnackBar(
                                                  content: Text(
                                                      AppLocalizations.of(context).tr("Email or password is not correct !"))));
                                        }
                                      }
                                    },
                                    child: Text(
                                      AppLocalizations.of(context).tr("JOIN"),
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  )
                                ],
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      AppLocalizations.of(context).tr("Remember me"),
                                      style: TextStyle(color: Colors.white),
                                    )
                                  ],
                                ),
                              ...
                              Container(
                                child: Text(
                                    AppLocalizations.of(context).tr("Forget my password"),
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
